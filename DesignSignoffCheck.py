...
#gCDLModificationScriptPath = "/home/cad1/kobe/programs/scripts/src/patch_res_values/patch_res_values.pl"
gCDLModificationScriptPath = "/home/cad1/ssfang/perl/patch_res_value/patch_res.pl"
#gDesignSignoffCheckMainPath = "/apps/imctf/cad/script/DesignSignoffCheck/Main/Latest/*/"
gPercReportComparisonScriptPath = "/apps/imctf/cad/script/DesignSignoffCheck/Other/Latest/compare_perc_report.py"
gDesignSignoffCheckCSVtoExcelPath = "/apps/imctf/cad/script/DesignSignoffCheck/Other/Latest/DesignSignoffCheckCSVtoExcel.py"
gDesignSignoffCheckCSVCreationPath = "/apps/imctf/cad/script/DesignSignoffCheck/Other/Latest/CreateSummaryCSV.py"
gDesignSignoffCheckResultForWesignCSV = "/apps/imctf/cad/script/DesignSignoffCheck/Other/Latest/WesignSummaryCSV.py"
...
if __name__ == "__main__":
  ...
  temp = temp.get()
  gDesignSignoffCheckMainPath = temp ["gDesignSignoffCheckMainPath"][0]
  ...
  for check in checks:
    ...
    if os.path.exists( "perc.rep" ):
      ...
      for line in read.readlines():
        ...
        matchABORT = re.match( r'^.*#\s+(ABORTED)\s+#', line )
        matchObjects = re.match( r'^\s*#\s+CHECK\(s\)\s+(\S+)\s+#', line )

        if matchABORT:
          if matchABORT.group( 1 ) == "ABORTED":
            print("The running is ABORTED")
            break
